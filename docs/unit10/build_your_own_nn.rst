...
.. note::
   ...
   Typically we would run these steps on hardware with a GPU, but this data and model are simple
   enough that we can run them on our class VMs.
...
.. tip::
    ...
    Don't forget to ``pip install ucimlrepo``
...
.. tip::
    ...
    Don't forget to ``pip install tensorflow``
